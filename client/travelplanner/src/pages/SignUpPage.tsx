...
export default function SignUpPage({ onNavigate }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage('Account created successfully! Redirecting to the homepage...')
      ...
      <div className="auth-container">
        ...
        <div className="auth-card glass">
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="auth-submit-btn auth-submit-btn--signup" disabled={isSubmitting}>
